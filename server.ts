...
const APP_URL =
  process.env.APP_URL || 'https://xf-code.netlify.app';

const DISCORD_CLIENT_ID =
  process.env.DISCORD_CLIENT_ID || '1535346943482531892';

const DISCORD_CLIENT_SECRET =
  process.env.DISCORD_CLIENT_SECRET || 'B3aNCQqySMphGAL3KnAlOXsrmBwNsktP';

const DISCORD_REDIRECT_URI =
  process.env.DISCORD_REDIRECT_URI ||
  'https://xf-code.netlify.app/';

const DISCORD_ADMIN_IDS =
  (process.env.DISCORD_ADMIN_IDS || '1412542344510574716')
    .split(',')
    .map(id => id.trim())
    .filter(Boolean);
